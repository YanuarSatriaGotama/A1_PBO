...
public class Posttest3 {
    ...
    static void data_class(){
        ...
        Studiofoto object = new Studiofoto();
        Studiofoto object2 = new Studiofoto();
        
        object.Studio("Fajri", "PraWedding", +628123934, "10R");
        object2.Studio("ZAHRA", "Wedding", +628124225, "12R");
